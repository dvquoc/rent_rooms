    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-layout" class="form-horizontal">
          ...
          <table id="module" class="table table-striped table-hover">
            <thead>
              <tr>
            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'content_block_one') { ?>
                    <option value="content_block_one" selected="selected">Block home 1</option>
                    <?php } else { ?>
                    <option value="content_block_one">Block home 1</option>
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'content_block_tow') { ?>
                    <option value="content_block_tow" selected="selected">Block home 2</option>
                    <?php } else { ?>
                    <option value="content_block_tow">Block home 2</option>
                    <?php } ?>
                  </select></td>
...
function addModule() {
    ...
    html += '    <option value="content_block_one">Home block 1</option>';
    html += '    <option value="content_block_tow">Home block 2</option>';
