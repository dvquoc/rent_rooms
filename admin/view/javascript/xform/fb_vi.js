...
(function() {
  Formbuilder.registerField('text', {
    ...
    addButton: "<span class='symbol'><span class='fa fa-font'></span></span> <div>Văn bản</div>",
...
(function() {
  Formbuilder.registerField('paragraph', {
    ...
    edit: "<%= Formbuilder.templates['edit/size']() %><%= Formbuilder.templates['edit/initial']() %>",
    addButton: "<span class=\"symbol\">&#182;</span><div>Vùng nhập tùy chỉnh</div>",
    defaultAttributes: function(attrs) {
      attrs.field_options.size = 'small';
      return attrs;
    }
...
(function() {
  Formbuilder.registerField('radio', {
    ...
    addButton: "<span class=\"symbol\"><span class=\"fa fa-circle-o\"></span></span> <div>Nút chọn nhiều</div>",
    defaultAttributes: function(attrs) {
...
(function() {
  Formbuilder.registerField('checkboxes', {
    ...
    edit: "<%= Formbuilder.templates['edit/options']({ includeOther: true }) %>",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-square-o\"></span></span> <div>Nút chọn</div>",
    defaultAttributes: function(attrs) {
      attrs.field_options.options = [
        {
          label: "",
...
(function() {
  Formbuilder.registerField('dropdown', {
    ...
    addButton: "<span class=\"symbol\"><span class=\"fa fa-caret-down\"></span></span> <div>Danh sách</div>",
    defaultAttributes: function(attrs) {
      attrs.field_options.options = [
        {
          label: "",
...
(function() {
  Formbuilder.registerField('file', {
    ...
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-file\"></span></span> <div>Tập tin</div>"
  });
...
(function() {
  Formbuilder.registerField('copy', {
    ...
    addButton: "<span class=\"symbol\"><span class=\"fa fa-file-text-o\"></span></span> <div>Vùng nhập văn bản</div>",
	defaultAttributes: function(attrs) {
...
(function() {
  Formbuilder.registerField('email', {
    ...
    view: "<input type='text' class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>' />",
    edit: "<%= Formbuilder.templates['edit/size']() %><%= Formbuilder.templates['edit/initial']() %>",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-envelope-o\"></span></span> <div>Email</div>",
    defaultAttributes: function(attrs) {
      attrs.field_options.size = 'small';
      return attrs;
    }
...
(function() {
  Formbuilder.registerField('date', {
    ...
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-calendar\"></span></span> <div>Ngày</div>"
  });
...
(function() {
  Formbuilder.registerField('time', {
    ...
    view: "<div class='input-line'>\n  <span class='hours'>\n    <input type=\"text\" />\n    <label>Giờ</label>\n  </span>\n\n  <span class='above-line'>:</span>\n\n  <span class='minutes'>\n    <input type=\"text\" />\n    <label>Phút</label>\n  </span>\n\n  <span class='above-line'>:</span>\n\n  <span class='seconds'>\n    <input type=\"text\" />\n    <label>Giây</label>\n  </span>\n\n  <span class='am_pm'>\n    <select>\n      <option>Sáng</option>\n      <option>Chiều</option>\n    </select>\n  </span>\n</div>",
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-clock-o\"></span></span> <div>Thời gian</div>"
  });
...
(function() {
  Formbuilder.registerField('submit', {
    ...
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-check\"></span></span> <div>Nút gửi</div>",
	defaultAttributes: function(attrs) {
	   attrs.required = false;
	   attrs.label = 'Gửi';
...
(function() {
  Formbuilder.registerField('captcha', {
    ...
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-question\"></span></span> <div>Captcha</div>"
  });
...
(function() {
  Formbuilder.registerField('hidden', {
    ...
    addButton: "<span class=\"symbol\"><span class=\"fa fa-eye-slash\"></span></span> <div>Ẩn</div>",
	defaultAttributes: function(attrs) {
	   attrs.required = false;
	   attrs.label = 'Ẩn';
       attrs.hide_label = true;
