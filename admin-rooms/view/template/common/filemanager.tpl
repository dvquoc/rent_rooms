...
$('a.thumbnail').on('click', function(e) {
	...
	if (sel.rangeCount && $(sel.baseNode).parents(".ge-content")) {
	    /* Chỉ dành cho Tinymce inline */
        ...
        console.log("This is edior iframe");
        if(tinymce!=undefined && tinymce.settings.app_default=='cdv'){
            tinymce.activeEditor.execCommand('mceInsertContent',false,"<img src='"+$(this).attr('href')+"' class='img-responsive'/>");
            tinymce.triggerSave();
        }else{
            console.log("Not is tinymce");
        }
    }
	<?php } ?>
