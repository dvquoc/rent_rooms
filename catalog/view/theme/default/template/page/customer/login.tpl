        ...
        <div id="qc3-body">
            <div class="container">
                <div class="login auth-container" id="client-login" style="">
                    ...
                    <p class="auth-header">Đăng nhập người tìm phòng</p>
                    <form id="form_login" accept-charset="utf-8">
                        ...
                        <div class="login-social">
                            ...
                            <div class="login-social-buttons">
                                <a class="auth-facebook-btn auth-clear-hover auth-clear-visited js-action-track_event" href="/cus-dang-nhap-fb" data-track_event-category="Button" data-track_event-action="Login FB" data-track_event-label="Login page" >
