            ...
            <div class="container">
                <div class="login auth-container" id="client-login" style="">
                    ...
                    <form action="/test" method="post" accept-charset="utf-8">
                        ...
                        <?php if($phone == ''){?>
                            <div><input type="text" placeholder="Nhập Số điện thoại" class="auth-input" name="phone"></div>
                        <?php }else{?>
                            <div><input type="text" placeholder="Nhập Email" class="auth-input" name="mail"></div>
                        <?php }?>
