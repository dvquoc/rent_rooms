...
<div class="contain-map contain-fluid-full" style="position: relative">
    ...
    <div id="show-list" class="col-md-3 noselect" style="display: none; border-radius: 3px; position: absolute; right:10px; bottom:10px; height: 100%; background-color: #fff; padding: 0px;box-shadow: rgba(0, 0, 0, 0.3) 0px 1px 4px -1px;">
