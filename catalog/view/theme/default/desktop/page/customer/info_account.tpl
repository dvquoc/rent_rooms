...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            <form id="form_update" action="/cap-nhat-tai-khoan" method="post" id="fileForm" role="form">
            ...
            <div class="form-group">
             ...
             <div class="form-group">     
                <label for="firstname"><span class="req"></span> Họ tên: </label>
                    <input class="form-control" type="text" name="firstname"  value="<?php echo $user['name']?>"/> 
            </div>
            ...
            <div class="form-group">
                <button><a href="/tim-kiem-phong-tro">Cancel</a></button> 
            </div>
            </fieldset>
