...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="header-contact text-center" style="background: url('/public/assets/images/contact_background.png') bottom; margin-top: -15px; padding: 50px 0px; margin-bottom: 30px; color: #fff;">
        <h1 style="color:#fff;"><?php echo $heading_title; ?></h1>
        <p>Bạn còn thiếu thông tin ? Hay bạn muốn được tư vấn một cách tháo đáo hơn. Hãy liên hệ với chúng tôi.</p>
      </div>
      <div class="row">
        <div class="col-md-6 col-right">
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              ...
              <div><i class="fa fa-home"></i> <?php echo $address; ?></div>
            </div>
