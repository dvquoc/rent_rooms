<?php
class ControllerObjectNewsDetail extends Controller {
    ...
    public function index() {
        ...
        $request_category=$this->_object['alias_url']['category']['request_id'];
        $router_category=$this->_object['alias_url']['category']['router_page'];

        $request_type=$this->_object['alias_url']['type']['request_id'];
        $router_type=$this->_object['alias_url']['type']['router_page'];

        $request_information=$this->_object['alias_url']['information']['request_id'];
        $router_information=$this->_object['alias_url']['information']['router_page'];
        ...
        if ($information) {
            ...
            if($category_info) {
                $data['breadcrumbs'][] = array(
                    ...
                    'href' => $this->url->link($router_category, $request_category. "=" . $category_info['category_id'])
                );
                $data['breadcrumbs'][] = array(
