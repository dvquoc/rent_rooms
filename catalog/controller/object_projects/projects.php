<?php
class ControllerObjectProjectsProjects extends Controller {
    public function index() {
        ...
        $this->document->addStyle("/public/assets/css/post_style.css");
        ...
        if ($category_info) {
            ...
            $data['col']=3;
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/part/content/grid_content.tpl')) {
                $data['list_information'] = $this->load->view($this->config->get('config_template') . '/template/part/content/grid_content.tpl',$data );
            } else {
                $data['list_information'] = $this->load->view($this->config->get('config_template') . '/template/part/content/grid_content.tpl', $data);
            }
